...
export const popularExchanges: CryptoProviderInfo[] = [
    ...
    { name: "Gate.io", iconUrl: "https://picsum.photos/seed/gateio/20/20", dataAiHint: "Gate.io logo" },
...
export const popularWallets: CryptoProviderInfo[] = [
    ...
    { name: "Trust Wallet", iconUrl: "https://picsum.photos/seed/trustwallet/20/20", dataAiHint: "Trust Wallet logo" },
    ...
    { name: "MyEtherWallet (MEW)", iconUrl: "https://picsum.photos/seed/mew/20/20", dataAiHint: "MyEtherWallet logo" },
    { name: "Phantom (Solana)", iconUrl: "https://picsum.photos/seed/phantom/20/20", dataAiHint: "Phantom Wallet logo" },
    { name: "Coinbase Wallet", iconUrl: "https://picsum.photos/seed/coinbasewallet/20/20", dataAiHint: "Coinbase Wallet logo" }, // Separate from the exchange
    { name: "Atomic Wallet", iconUrl: "https://picsum.photos/seed/atomicwallet/20/20", dataAiHint: "Atomic Wallet logo" },
