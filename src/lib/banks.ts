...
export const popularBanks: BankInfo[] = [
    // Brazil
    { name: "Banco do Brasil", iconUrl: "https://picsum.photos/seed/bancodobrasil/20/20", dataAiHint: "Brasil logo" },
    { name: "Itaú Unibanco", iconUrl: "https://picsum.photos/seed/itau/20/20", dataAiHint: "Itau logo" },
    { name: "Caixa Econômica Federal", iconUrl: "https://picsum.photos/seed/caixa/20/20", dataAiHint: "Caixa Federal" },
    ...
    { name: "Banco Inter", iconUrl: "https://picsum.photos/seed/inter/20/20", dataAiHint: "Inter logo" },
    { name: "BTG Pactual", iconUrl: "https://picsum.photos/seed/btg/20/20", dataAiHint: "BTG Pactual" },
    { name: "XP Investimentos", iconUrl: "https://picsum.photos/seed/xp/20/20", dataAiHint: "XP logo" },
    { name: "Banco Safra", iconUrl: "https://picsum.photos/seed/safra/20/20", dataAiHint: "Safra logo" },
    { name: "Banco Original", iconUrl: "https://picsum.photos/seed/original/20/20", dataAiHint: "Original logo" },
    { name: "C6 Bank", iconUrl: "https://picsum.photos/seed/c6/20/20", dataAiHint: "C6 Bank" },
    { name: "PagBank", iconUrl: "https://picsum.photos/seed/pagbank/20/20", dataAiHint: "PagBank logo" },
    { name: "Banco Neon", iconUrl: "https://picsum.photos/seed/neon/20/20", dataAiHint: "Neon logo" },
    { name: "Banco Pan", iconUrl: "https://picsum.photos/seed/pan/20/20", dataAiHint: "Pan logo" },
    ...
    { name: "Lloyds Banking Group (UK)", iconUrl: "https://picsum.photos/seed/lloyds/20/20", dataAiHint: "Lloyds Bank" },
    ...
    { name: "BNP Paribas (France)", iconUrl: "https://picsum.photos/seed/bnp/20/20", dataAiHint: "BNP Paribas" },
    { name: "Crédit Agricole (France)", iconUrl: "https://picsum.photos/seed/creditagricole/20/20", dataAiHint: "Credit Agricole" },
    { name: "Société Générale (France)", iconUrl: "https://picsum.photos/seed/societegenerale/20/20", dataAiHint: "Societe Generale" },
    { name: "Deutsche Bank (Germany)", iconUrl: "https://picsum.photos/seed/deutsche/20/20", dataAiHint: "Deutsche Bank" },
    ...
    { name: "Intesa Sanpaolo (Italy)", iconUrl: "https://picsum.photos/seed/intesasanpaolo/20/20", dataAiHint: "Intesa Sanpaolo" },
    { name: "UBS (Switzerland)", iconUrl: "https://picsum.photos/seed/ubs/20/20", dataAiHint: "UBS logo" },
    { name: "Credit Suisse (Switzerland - now part of UBS)", iconUrl: "https://picsum.photos/seed/creditsuisse/20/20", dataAiHint: "Credit Suisse" },
    { name: "Nordea (Nordics)", iconUrl: "https://picsum.photos/seed/nordea/20/20", dataAiHint: "Nordea logo" },
    { name: "Danske Bank (Denmark/Nordics)", iconUrl: "https://picsum.photos/seed/danskebank/20/20", dataAiHint: "Danske Bank" },
